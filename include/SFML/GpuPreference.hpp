...
#  else
// Minimal fallback: detect Windows platform when SFML/Config.hpp isn't available
#    if defined(_WIN32) || defined(_WIN64)
#      define SFML_SYSTEM_WINDOWS
#    endif
#  endif
#else
// Compiler doesn't support __has_include: use platform detection as a fallback
#  if defined(_WIN32) || defined(_WIN64)
#    define SFML_SYSTEM_WINDOWS
#  endif
#endif
